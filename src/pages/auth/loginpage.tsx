  ...
  return (
            ...
            <div className="flex justify-center items-center">
              ...
              >
                ...
                >
                  ...
                  {/* ✅ onKeyDown attached to wrapper div so Enter works from any field */}
                  <div className="relative space-y-4" onKeyDown={handleKeyDown}>
                    {/* User ID */}
                    <div>
                      ...
                      <input
                        ...
                        autoComplete="email"
                        // ✅ Tab to password field naturally
                        tabIndex={1}
    ...
    bg-white focus:outline-none focus:ring-2 transition-all text-sm`}
                        ...
                        <button
                          ...
                          // ✅ tabIndex -1 so toggle doesn't break Tab flow
                          tabIndex={-1}
