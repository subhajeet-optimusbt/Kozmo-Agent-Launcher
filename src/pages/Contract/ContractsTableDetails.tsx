...
// const SECTIONS = [
//   { key: "overview", label: "Overview", icon: FileText, apiKey: "contractEntity" },
//   { key: "documents", label: "Documents", icon: Folder, apiKey: "documents" },
//   { key: "milestones", label: "Milestones", icon: Flag, apiKey: "contractMilestones" },
//   { key: "provisions", label: "Provisions", icon: FileSignature, apiKey: "contractKeyProvisions" },
//   { key: "obligations", label: "Obligations", icon: ListChecks, apiKey: "contractObligations" },
//   { key: "clauses", label: "Clauses", icon: Scale, apiKey: "contractClauses" },
//   { key: "pricing", label: "Pricing Terms", icon: DollarSign, apiKey: "contractPricingTerms" },
//   { key: "provenance", label: "Provenance", icon: ShieldCheck, apiKey: "provenance" },
// ];
...
//           <h3 className="font-semibold">{c.clauseType}</h3>
...
//       <Info label="Created On" value={formatDate(data.createdOn)} />
//       <Info label="Modified By" value={data.modifiedBy} />
//       <Info label="Modified On" value={formatDate(data.modifiedOn)} />
//     </div>
//   );
// }
