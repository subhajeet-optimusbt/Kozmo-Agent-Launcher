...
export default function ContractPreviewDrawer({
  contract,
  onClose,
}: {
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6 bg-gray-50">
            ...
            <div className="grid grid-cols-2 gap-5 text-sm">
              <Info label="Business Area" value={contract.area} />
              <Info label="Contract Type" value={contract.type} />
              <Info label="Company" value={contract.company} />
              <Info label="Counterparty" value={contract.counterparty} />
              <Info label="Last Updated" value={contract.updated} />
            </div>
          ...
          <div className="px-6 py-4 border-t bg-white">
            <Button
              ...
              onClick={() => {
                navigate(`/contracts/${contract.key}`);
                onClose();
              }}
            >
              View Full Contract
